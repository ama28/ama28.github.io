    ...
    <>
      <div style={OVERLAY_STYLE} onClick={() => props.closeModal()}>
        <div style={MODAL_STYLE} onClick={(e) => handleChildElementClick(e)}>
          <img src={process.env.PUBLIC_URL + "/assets/images/minecraft.jpg"} width="100%"></img>
          ...
          Suspendisse laoreet, diam sed tincidunt porta, sem tellus ultrices lectus, in auctor mauris nisi at massa. Pellentesque vitae dapibus erat. In hac habitasse platea dictumst. Mauris bibendum orci in urna elementum, ac mattis erat sagittis. Aenean suscipit nisi lacus. Pellentesque sagittis est arcu, suscipit interdum purus ultricies sit amet. Suspendisse eleifend iaculis odio, eu consectetur erat elementum ut. Pellentesque imperdiet purus eget sapien vulputate, non gravida odio vulputate. Sed rutrum feugiat risus, non vehicula est hendrerit vitae. Suspendisse consectetur velit in ipsum posuere, varius sagittis tellus dignissim. Mauris nec dapibus odio. Maecenas sit amet arcu erat. Maecenas consectetur et neque quis semper. Suspendisse fringilla ex eget odio malesuada iaculis. Proin eu augue vel neque efficitur dignissim eget quis nulla.
